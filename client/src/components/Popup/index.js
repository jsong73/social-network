...
const Popup = () => {
    ...
    <h3 className="text-lg font-medium text-red-900 dark:text-red-800"> Are you sure? </h3>
  </div>
  <div className="mt-2 mb-4 text-sm text-red-900 dark:text-red-800">
    Are you sure you want to delete this? This cannot be undone. 
  </div>
  <div className="flex">
    <button type="button" className="text-white bg-red-900 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-xs px-3 py-1.5 mr-2 text-center inline-flex items-center dark:bg-red-800 dark:hover:bg-red-900">
